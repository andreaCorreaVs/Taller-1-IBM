...
export default {
  ...
  methods: {
    async getCurrentStanding() {
      ...
      this.$refs.frente_amplio.innerHTML = "<h3>Frente Amplio: "+currentStanding[2]+"</h3>";
      this.$refs.partido_colorado.innerHTML = "<h3>Partido Colorado: "+currentStanding[7]+"</h3>";
      this.$refs.peri.innerHTML = "<h3>P.E.R.I: "+currentStanding[6]+"</h3>";
      this.$refs.partido_digital.innerHTML = "<h3>Partido Digital: "+currentStanding[8]+"</h3>";
      this.$refs.partido_independiente.innerHTML = "<h3>Partido Independiente: "+currentStanding[9]+"</h3>";
      this.$refs.partido_nacional.innerHTML = "<h3>Partido Nacional: "+currentStanding[10]+"</h3>";
      this.$refs.partido_verde_animalista.innerHTML = "<h3>Partido Verde Animalista: "+currentStanding[11]+"</h3>";
      this.$refs.partido_de_la_gente.innerHTML = "<h3>Partido de la Gente: "+currentStanding[12]+"</h3>";
      this.$refs.partido_de_los_trabajadores.innerHTML = "<h3>Partido de los Trabajadores: "+currentStanding[13]+"</h3>";
      this.$refs.unidad_popular.innerHTML = "<h3>Unidad Popular: "+currentStanding[15]+"</h3>";
      this.hideSpinner();
    },
    async runSpinner() {
