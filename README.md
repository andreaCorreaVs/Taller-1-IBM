# Hands-on Blockchain / IBM CodeDay MVD 2019
...
Hyperledger Fabric es una implementación open source de un ledger distribuido **permisionado**. El ledger distribuido es una base de datos distribuida que es replicada y sincronizada con los participantes de la red en la que se registran las transacciones entre los participantes. 
